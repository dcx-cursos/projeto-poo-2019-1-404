...
public class Tabuleiro {
	...
	public Tabuleiro(Listas repositorio) {
		this.listas = repositorio;
		this.tabuleiro = repositorio.getTabuleiro();
	...
	public void criarCasasNoTabuleiro() {
		tabuleiro.add(new Ponto_de_Partida("Ponto de Partida", 0));																			//POSICAO 00
		tabuleiro.add(new PropriedadeComercializavelImovel("Leblon", "lilás",100,6,30,90,270,400,500,50,0,1));										//POSICAO 01
		tabuleiro.add(new PropriedadeEspecialSorteReves("Sorte ou Reves", 2, this.listas));																//POSICAO 02
		...
		tabuleiro.add(new PropriedadeEspecialSorteReves("Sorte ou Reves", 12, this.listas));																//POSICAO 12
		...
		tabuleiro.add(new PropriedadeEspecialSorteReves("Sorte ou Reves", 16, this.listas));																//POSICAO 16
		...
		tabuleiro.add(new PropriedadeEspecialSorteReves("Sorte ou Reves", 22, this.listas));																//POSICAO 22
		...
		tabuleiro.add(new PropriedadeEspecialSorteReves("Sorte ou Reves", 37, this.listas));																//POSICAO 37
